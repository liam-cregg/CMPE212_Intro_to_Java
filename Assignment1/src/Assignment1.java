...
public class Assignment1 {
    ...
    public static void main(String[] args) {
        ...
        SCREEN.nextLine();
        for (int i = 0; playerScore < 100 && computerScore < 100; i++) {
            if(playersTurn) {
            ...
            if(playersTurn && playerScore < 100 && computerScore < 100) {
     ...
     * It's strategy is to stop playing if it's turn score is high enough to win, or over 40.
